...
{
    public class EklmContext : DbContext
    {
        public EklmContext(DbContextOptions<EklmContext> options) : base(options)
        {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<HFunc>().HasData(
                new HFunc
                {
                    Id = "H0261",
...
ELSE
   UPDATE t_sys_system SET sys_var_value='1' WHERE sys_var_id='use_Pub_ZKProm'",
        ...
        public DbSet<HFunc> HFuncs { get; set; }
    }
}